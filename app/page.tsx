        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="w-full max-w-xl lg:max-w-3xl mx-auto px-4">
            ...
            >
              ...
              {/* Input Container */}
              <div className="relative flex gap-3 sm:gap-4 items-center bg-black/70 backdrop-blur-2xl rounded-2xl sm:rounded-3xl px-4 sm:px-6 py-4 sm:py-5 border-2 border-cyan-500/30 group-hover:border-cyan-400/60 group-active:border-cyan-300/80 transition-all duration-300 shadow-2xl">
                <Music 
                  size={20} 
