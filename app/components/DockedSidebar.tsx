...
export default function DockedSidebar() {
  ...
  const menuItems: MenuItem[] = user ? [
    ...
    { icon: Unlock, label: 'Decrypt', href: '/decrypt', highlight: false },
    ...
    { icon: AudioLines, label: 'Voice Labs', href: '/voice-labs', highlight: false },
    { icon: Swords, label: 'Quests', href: '/quests', highlight: false, badge: '🎮' },
    { icon: Bot, label: '444 Assistant', href: '/assistant', highlight: false, badge: 'AI' },
    { icon: Settings, label: 'Settings', href: '/settings', highlight: false },
    { icon: User, label: 'My Profile', href: `/profile/${user.id}`, highlight: false, badge: '🎤' },
  ] : [
    { icon: Home, label: 'Home', href: '/', highlight: false },
    { icon: Zap, label: 'Create', href: '/create', highlight: true, badge: 'Suggested' },
    { icon: Compass, label: 'Radio', href: '/radio', highlight: false },
