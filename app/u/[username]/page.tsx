...
export default function UsernameProfilePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center md:pl-20 md:pr-20">
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-32 md:pl-20 md:pr-20">
