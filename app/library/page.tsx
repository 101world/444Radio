    ...
    try {
      ...
      if (musicData.success && Array.isArray(musicData.music)) {
        ...
        const nonStemMusic = uniqueMusic.filter((track: any) =>
          track.genre !== 'stem' && track.genre !== 'boosted' && track.genre !== 'extract' && track.genre !== 'loop' && track.genre !== 'effects' && track.genre !== 'processed' && track.genre !== 'chords' && track.genre !== 'voice-over' && track.genre !== 'beatmaker' && track.genre !== '444-extend' && track.genre !== '444-upload-extend' && track.genre !== '444-inpaint' && track.genre !== '444-cover' && track.genre !== '444-remix' && track.genre !== '444-add-vocals' && track.genre !== '444-voice-to-melody' &&
