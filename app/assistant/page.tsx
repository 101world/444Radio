...
const QUICK_PROMPTS = [
  ...
  { icon: Mic, label: 'Vocal production', prompt: 'I want to record and process vocals. What\'s the best workflow using 444 Radio\'s tools like Autotune and Voice to Melody?', color: 'from-pink-500/20 to-rose-500/10 border-pink-500/20 hover:border-pink-400/40' },
