...
export async function POST(req: NextRequest) {
  try {
    ...
    if (contentType.includes('application/json')) {
      ...
      console.log('[Banner API] Request:', { useLatestCover, hasCoverUrl: !!coverUrl })
      if (useLatestCover) {
        ...
        console.log('[Banner API] Found', rows?.length, 'covers')
      ...
      console.log('[Banner API] Upload:', { hasFile: !!file, kind, size: file?.size })
    ...
    console.log('[Banner API] ✅ Success for user:', userId)
