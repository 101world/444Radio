...
-- This prevents race conditions by checking and deducting in a single transaction
...
GRANT EXECUTE ON FUNCTION deduct_credits(TEXT, INTEGER) TO anon, authenticated;
