-- Migration 140: Fix deduct_credits function
--
-- Migration 129 sorts AFTER 1027 alphabetically ("1027" < "129"),
-- overwriting the wallet-gate-removed version with the old $1 gate version.
-- This migration applies the correct final version:
--   - NO wallet gate
--   - Consumes free_credits first, then paid credits
...
BEGIN
  ...
  -- Check total covers the request (NO wallet gate)
  ...
  -- PRIORITY 2: Consume paid credits
