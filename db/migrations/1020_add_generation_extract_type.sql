-- Add 'generation_extract' to credit_transactions type CHECK constraint
-- Required for the Extract Audio feature (video-to-audio + stem extraction)
...
BEGIN
  ...
  -- Re-create with ALL types including generation_extract
